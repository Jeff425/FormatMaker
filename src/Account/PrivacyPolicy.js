export const privacyTitle = "KhalorlStudios, LLC Privacy Policy";

export const privacyBody = `
This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://formatbuilder.com (the "Site").
...
CONTACT US
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at khalorlstudios@gmail.com or by mail using the details provided below:

  3324 145th pl se, Mill Creek, WA, 98012, United States
`;